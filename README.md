...
**Use in version v0.4.10**
```html
<script src="https://cdn.jsdelivr.net/npm/aframe-resonance-audio-component@0.4.10/dist/aframe-resonance-audio-component.min.js"></script>
```
